...
contract UEDCsLockedStaking is Ownable{
    using SafeMath for uint256;

    IBEP20 public uedcToken;
    uint256 constant public INVEST_MIN_AMOUNT = 100 ether; 
    uint256 constant public INVEST_MAX_AMOUNT = 20000000 ether;
    uint256 constant public WITHDRAW_MIN_AMOUNT = 100 ether;
    uint256[] internal REFERRAL_PERCENTS = [500, 0, 0];
    uint256 constant public DEPOSIT_WITHDRAW_FEE = 300; // 3% Fee for each invest/withdraw
    ...
    constructor() {
        ...
        uedcToken = IBEP20(0xB12938c90A8165b556b41c27531183f11EBFF69C);
        marketingAddress = payable(owner);
        plans.push(Plan(365, 82));
    }
